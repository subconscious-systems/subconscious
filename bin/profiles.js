...
const SETTINGS = {
  ...
  CLAUDE_CODE_SUBAGENT_MODEL: {
    ...
    description:
      'Model used by Claude Code subagents. UNSET follows the default model.',
    type: 'choice',
    choices: SUPPORTED_MODELS,
  },
  CLAUDE_GATEWAY_URL: {
  ...
  CODEX_EXTERNAL_TOOLS: {
    ...
    description:
      'Enable Codex apps/plugins; may exceed the gateway tool limit.',
    type: 'choice',
    choices: ['false', 'true'],
  },
  OPENCODE_API_KEY: {
...
const GROUP_KEYS = [
  {
    ...
    keys: ['GATEWAY_URL', 'API_KEY', 'MODEL'],
  },
  ...registry.agents
...
export function modelsCommand(models = SUPPORTED_MODELS, options = {}) {
  const selectedModel =
    options.selectedModel || models[0] || registry.defaults.model;
