...
# Gateway upstreams can't perform Anthropic's server-side auto mode classifier
# checks; opting out avoids the "isn't eligible for no-charge classifier
# requests" fallback and keeps classifier requests billed locally.
