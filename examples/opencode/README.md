...
export OPENCODE_CONFIG_CONTENT='{"$schema":"https://opencode.ai/config.json","provider":{"subconscious":{"npm":"@ai-sdk/openai-compatible","name":"Subconscious","options":{"baseURL":"https://api-dev.subconscious.dev/v1","apiKey":"{env:SUBCONSCIOUS_API_KEY}"},"models":{"subconscious/tim-qwen3.6-27b":{"name":"Subconscious","tools":true}}}},"model":"subconscious/subconscious/tim-qwen3.6-27b"}'
opencode
```
